...
export interface BananaAccountProxyFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createChainSpecificProxyWithNonce" | "createProxyWithCallback" | "createProxyWithNonce" | "getAddress" | "getBytecode" | "getChainId" | "proxyCreationCode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getBytecode", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
...
export interface BananaAccountProxyFactory extends BaseContract {
    ...
    functions: {
        ...
        getAddress(_singleton: PromiseOrValue<string>, _salt: PromiseOrValue<BigNumberish>, initializer: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
        getBytecode(_owner: PromiseOrValue<string>, _foo: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        getAddress(_singleton: PromiseOrValue<string>, _salt: PromiseOrValue<BigNumberish>, initializer: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        getBytecode(_owner: PromiseOrValue<string>, _foo: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAddress(_singleton: PromiseOrValue<string>, _salt: PromiseOrValue<BigNumberish>, initializer: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getBytecode(_owner: PromiseOrValue<string>, _foo: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
