...
export { ADD_WALLETCRED_ROUTE, GET_WALLETCRED_ROUTE, CHECK_INITCODE_ROUTE, IS_WALLETNAME_UNIQUE_ROUTE, REGISTRATION_LAMBDA_URL, VERIFICATION_LAMBDA_URL, K1_SIGNATURE_LAMBDA_URL }