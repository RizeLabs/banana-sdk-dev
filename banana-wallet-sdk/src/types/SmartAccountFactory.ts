...
export interface SmartAccountFactoryInterface extends utils.Interface {
  functions: {
    ...
    "deployAccount(uint256[2])": FunctionFragment;
    "deployCounterFactualAccount(uint256[2],uint256)": FunctionFragment;
    "getAddressForCounterFactualAccount(uint256[2],uint256)": FunctionFragment;
