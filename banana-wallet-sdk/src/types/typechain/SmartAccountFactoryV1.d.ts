...
interface SmartAccountFactoryV1Interface extends ethers.utils.Interface {
  functions: {
...
export class SmartAccountFactoryV1 extends BaseContract {
  ...
  interface: SmartAccountFactoryV1Interface;
