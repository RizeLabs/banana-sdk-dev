...
export interface VerifyingPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "getSenderPaymasterNonce((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getSenderPaymasterNonce(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getSenderPaymasterNonce((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))",
